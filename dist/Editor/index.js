...
export var Editor = forwardRef(function (_a, ref) {
    var defaultFontSize = _a.defaultFontSize, _b = _a.defaultWidth, defaultWidth = _b === void 0 ? "100%" : _b, _c = _a.defaultFontColor, defaultFontColor = _c === void 0 ? "#404040" : _c, editorID = _a.editorID, _d = _a.environmentColor, environmentColor = _d === void 0 ? "white" : _d, _e = _a.placeholder, placeholder = _e === void 0 ? "텍스트를 입력해주세요" : _e;
    var editorRef = useRef(null);
    var _f = useState(undefined), editorDoc = _f[0], setEditorDoc = _f[1];
    ...
    var onLoadIfr = function () {
        if (editorRef === null || editorRef === void 0 ? void 0 : editorRef.current) {
            var iframeRef = editorRef.current
                .contentWindow;
            ...
            if (editorElement_1 && ref) {
                ref.current = editorElement_1;
            }
            if (!placeholder) {
    ...
    var iframeContent = "\n    <!DOCTYPE html>\n    <html>\n      <head>\n      <style>\n        ".concat(editorstyle, "\n      </style>\n        <title>likelion editor</title>\n      </head>\n      <body id=\"editor\" contenteditable=\"true\" style=\"overflow-x: hidden; height: 100%; box-sizing: border-box; font-size:").concat(defaultFontSize ? defaultFontSize : "0.8rem", ";y\n      ").concat(environmentColor === "white" && "color: #404040", ";\n      ").concat(environmentColor === "dark" && "color: white", ";\n      ").concat(defaultFontColor && "color: ".concat(defaultFontColor), ";\n      \">\n      <p><br/></p>\n      </body>\n    </html>\n  ");
